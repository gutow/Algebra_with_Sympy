...
class Equation(Expr):
    ...
    def __init__(self,lhs,rhs,relop='='):
        ...
        if (simplify(lhs).is_number) and (simplify(rhs).is_number) and not (lhs == rhs):
...
#####
    ...
    def __add__(self, other):
        if (type(other) is Equation):
            raise NotImplementedError('Addition of equations not supported.')
    ...
    def __sub__(self, other):
        if (type(other) is Equation):
            raise NotImplementedError('Subtraction of equations not supported.')
        lhs = Add(self.lhs,-other)
        rhs = Add(self.rhs,-other)
        return equ(lhs,rhs)
    ...
    def __mul__(self, other):
        if (type(other) is Equation):
            raise NotImplementedError('Multiplication of equations not supported.')
    ...
    def _pow(self, other):
        if (type(other) is Equation):
            raise NotImplementedError('Raising to the power of an equation not supported.')
